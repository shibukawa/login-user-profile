...
function parseGitResult(stdout) {
    var result = {};
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    if (cwd) {
                        child_process_1.exec(command, { cwd: cwd }, function (err, stdout) {
                            if (err) {
                                reject(err);
                                return;
                            }
...
exports.parseGitSetting = parseGitSetting;
